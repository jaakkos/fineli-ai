...
// pnpm resolves drizzle-orm to separate copies for sqlite/pg peer-dep combinations,
// causing SQL<unknown> type mismatch in IDE linter (tsc --noEmit passes fine).
// This cast satisfies the pg-core timestamp column's `.default()` type signature.
